<template>
<el-row class="parent">
  <el-col :span="1"><el-button  type="text" @click="parent"><i class="el-icon-caret-top"></i>向上</el-button></el-col>
  <el-col :span="1"><el-button  type="text" @click="retreat"> <i class="el-icon-arrow-left"></i>后退</el-button></el-col>
  <el-col :span="1"><el-button  type="text" @click="goforward">前进<i class="el-icon-arrow-right"></i></el-button></el-col>
  <el-col :span="21" >
