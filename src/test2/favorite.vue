<template>
  <div>
   <el-button type="text" @click="showfavorite" class="hidden-md-and-down">我的收藏</el-button>
    <el-button type="text" @click="showfavorite" class="hidden-lg-and-up"><i class="el-icon-star-on"></i></el-button>
    <el-dialog top='20%' size="65%" title="我的收藏" :visible.sync="dialogFormVisible1">
      ...
      <el-col>
      <el-popover ref="popover5" placement="top" width="160px" :visible.sync="visible2">
...
<el-button v-popover:popover5 width="160px">操作</el-button>
  <el-button @click="goBack" width="160px">返回</el-button>
      </el-col>
      </el-row>
       <el-table v-if="this.ss=='1'" class="usertable" :data="tableData" border 
      ref="multipleTable" @row-dblclick="gonext"  @selection-change="handleSelectionChange" >
       <el-table-column type="selection" >
    </el-table-column>
       <el-table-column  prop="lableName" label="收藏文件" >
          </el-table-column>
       <el-table-column  prop="date" label="创建日期" >
          </el-table-column>
       
      </el-table>
         <el-table v-else class="usertable" :data="tableData"  border  
      ref="multipleTable"  @row-dblclick="gonext"  @selection-change="handleSelectionChange" >
       <el-table-column type="selection" >
    </el-table-column>
          <el-table-column  prop="lableName" label="收藏夹">
          </el-table-column>
      </el-table>
    </el-dialog>
