...
<el-row :span="24" :gutter="20" class="container">
     ...
     <el-card :body-style="{ padding: '0px' }">
          <el-col class="head" :span="24">
            ...
            <el-col :span="5" class="btn">
              <el-button type='text' size="small" @click="choose">选定组</el-button>    
            </el-col>
          </el-col>
          <hr class="line">
          <el-col  class="main" :span="24">
            <select size=1000 multiple class="select" v-model='selectdata'>
               <option v-for='i in department' v-bind:value='i' @click="departmentclick">{{i}}</option>
            </select>
          </el-col>
        </el-card>
  </el-col>
  <el-col :span="8" class="boxcard">
     <el-card :body-style="{ padding: '0px' }">
          <el-col class="head" :span="24">
            <el-col :span="24" class="name">2.教职工</el-col>
          </el-col>
          <hr class="line">
          <el-col  class="main" :span="24">
...
export default {
       created(){
		...
		methods: {
      choose(){
        Bus.$emit('choosedata',this.selectdata);
      },
