        ...
        <el-col :span='12'>
            <el-col>
                ...
                <el-col :span='16' :pull='2'>
                    <el-select size='small' disabled placeholder="组">
                        <el-option></el-option>
                    </el-select>
                </el-col>
            </el-col>
            ...
            <el-col :push='17'><el-button size='small' @click='stratselect'>开始查找</el-button></el-col>
        </el-col>
        <el-col :span='12'>
            <el-col :push='2'>
...
import Bus from '../../Bus.js';
       ...
       methods:{
           ...
           choose(){
              Bus.$emit('choosedata',this.selecteddata);
           },
