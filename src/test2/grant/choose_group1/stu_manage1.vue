...
<el-row :span="24" class="container">
  <el-col :span="16">
      ...
      <el-col :span="12" class="boxcard">
        <el-card :body-style="{ padding: '0px' }">
          <el-col class="head" :span="24">
            <el-col  :span="24" class="name">1.学院（系）</el-col>
          </el-col>
          <hr class="line">
    ...
    <el-row :gutter="20" :span="24">
      ...
      <el-col :span="12" class="boxcard">
        <el-card :body-style="{ padding: '0px' }">
          <el-col class="head" :span="24">
            <el-col  :span="24" class="name">2.专业</el-col>
          </el-col>
          <hr class="line">
          <el-col  class="main" :span="24">
            <select size=1000 multiple class="select">
  ...
  <el-col :span="8">
      <el-col :span="12" class="boxcard1">
        <el-card :body-style="{ padding: '0px' }">
          <el-col class="head" :span="24">
            <el-col  :span="18" class="name">5.学生</el-col>
          ...
          <hr class="line">
          <el-col  class="main" :span="24">
            <select size multiple class="select" v-model='selectdata'>
               <option v-for='i in stu'  v-bind:value='i'  >{{i}}</option>
            </select>
          </el-col>
        </el-card>
      </el-col>
