...
import stumanage from './stu_manage1.vue';
import tcmanage from './tc_manage1.vue';
import groupselect from './select1.vue';
       export default {
       created() {
       Bus.$on('qwer', data => {
         this.dialogFormVisible=true;
         this.selectdata=[]; });
       Bus.$on('choosedata1', data => {//对比选中的数据和原有的数据，相同的跳过，不同的追加进去
